...
export default function UserConserns() {
  let userCheckOptions = [
    ...
    { id: 3, option: "Psoriasis" },
    { id: 4, option: "Other", type: "other", isTrue: false },
    {
      id: 4,
      option:
        "I'm not sure, but want help with my irritated, red, or itchy skin",
      type: "unknown",
      isTrue: false,
    },
  ];
  ...
  return (
    <>
      <div>
        <div>
          <h3>
            Facet specializes in several skin concerns. What are you looking for
            help with today?
          </h3>
          <p>
            Our derm experts are here for you. Select all that apply so we can
            tailor this consultation to your unique needs.
          </p>
        </div>
