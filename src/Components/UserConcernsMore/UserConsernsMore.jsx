...
export default function UserConsernsMore() {
  ...
  const [userInputCheckData, setUserInputCheckData] =
    useState(userCheckOptions);
    ...
    <>
      ...
      <div>
        ...
        <div>
          ...
          <h4>Face Tip</h4>
          <p>
            Have more than one symptom? That’s very common! Our providers can
            help you with a range of symptoms. Unfortunately, they won’t be able
            to examine or treat moles or skin growths as those require
            face-to-face evaluation with an appropriate medical provider.
            Features of suspicious lesions include but are not limited to:
            change in shape, size, color, or texture, symptoms (such as itching,
            pain, bleeding, or oozing), and stores or pimples that fail to heal
            within 3-4 weeks.
          </p>
        </div>
        <div>
