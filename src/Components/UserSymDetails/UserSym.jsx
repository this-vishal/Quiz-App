...
export default function UserSym({ handleRenderComponent,question, options, option_type, facet, getSymptumDetails }) {
...
let isSingleOption = false
    ...
    const setSymData = (e, question, option_type = 'multi_option') => {
            ...
            <div>
                ...
                {!isSingleOption?
                        options.map((data) => {
                                ...
                                return (
                                    <div>
                                        <input type="checkbox"
                                            ...
                                            name={data.option} onChange={(e) => setSymData(e, question,option_type)} />
                            ...
                            return (
                                <div>
                                    <input type="radio" checked={value===data.option}
